...
public class ActaDeNotasMenu {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("3. Clasificar notas");
            ...
            switch (opcion) {
                case 1:
                    Scanner lectorOrden = new Scanner(System.in);
                    System.out.println("¿Desea ordenar las notas de forma ascendente o descendente? (ascendente: 1, descendente: 0): ");
                    int tipoOrden = lectorOrden.nextByte();

                    TreeMap<String, Double> notasOrdenadas = new TreeMap<>((a, b) -> {
                        if (tipoOrden == 1) {
                            return notaTotalMap.get(a).compareTo(notaTotalMap.get(b));
                        } else {
                            return notaTotalMap.get(b).compareTo(notaTotalMap.get(a));
                        }
                    });

                    notasOrdenadas.putAll(notaTotalMap);
                ...
                case 2:
                    Scanner lectorBusqueda = new Scanner(System.in);
                    System.out.print("Ingrese el valor mínimo del rango: ");
                    double min = lectorBusqueda.nextDouble();
                    System.out.print("Ingrese el valor máximo del rango: ");
                    double max = lectorBusqueda.nextDouble();

                    System.out.println("Notas dentro del rango [" + min + " - " + max + "]:");
                    for (String apellido : notaTotalMap.keySet()) {
                        double nota = notaTotalMap.get(apellido);
                ...
                case 3:
                TreeMap<String, String> notasClasificadas = new TreeMap<>();
                ...
                for (String apellido : notaTotalMap.keySet()) {
                    ...
                    notasClasificadas.put(apellido, asteriscos.toString());
                }

                System.out.println("Clasificación de Notas:");
                for (String apellido : notasClasificadas.keySet()) {
                    System.out.println(apellido + ": " + notasClasificadas.get(apellido));
                }
                    break;
